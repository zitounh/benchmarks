...
(declare-fun |sine.1.0::main::1::IN@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |sine.1.0::main::2::result@1!0&0#1| () (_ FloatingPoint 8 24))
...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (= a!3 |sine.1.0::main::2::result@1!0&0#1|))))
(assert (= (fp.leq |sine.1.0::main::2::result@1!0&0#1|
           (fp #b0 #x7e #b11111010111000010100100))
   |goto_symex::guard@0!0&0#1|))
(assert (= (fp.geq |sine.1.0::main::2::result@1!0&0#1|
           (fp #b1 #x7e #b11111010111000010100100))
   |goto_symex::guard@0!0&0#2|))
(assert (let ((a!1 (ite (and (fp.gt |sine.1.0::main::1::IN@1!0&0#1|
                            (fp #b1 #x7f #b10010010000111111011011))
                     (fp.lt |sine.1.0::main::1::IN@1!0&0#1|
