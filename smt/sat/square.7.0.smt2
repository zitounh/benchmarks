...
(declare-fun |square.7.0::main::1::IN@1!0&0#1| () (_ FloatingPoint 8 24))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (= (fp.sub roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     a!3
                     |square.7.0::main::1::IN@1!0&0#1|))
     |square.7.0::main::2::result@1!0&0#1|)))
(assert (= (fp.geq |square.7.0::main::2::result@1!0&0#1|
           (fp #b0 #x00 #b00000000000000000000000))
   |goto_symex::guard@0!0&0#1|))
(assert (= (fp.lt |square.7.0::main::2::result@1!0&0#1|
          (fp #b0 #x7f #b01100110011001100110011))
   |goto_symex::guard@0!0&0#2|))
(assert (let ((a!1 (ite (and (fp.geq |square.7.0::main::1::IN@1!0&0#1|
                             (fp #b0 #x00 #b00000000000000000000000))
                     (fp.lt |square.7.0::main::1::IN@1!0&0#1|
                            (fp #b0 #x7f #b00000000000000000000000)))
                #x00000001
                #x00000000)))
