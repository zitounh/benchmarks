...
(declare-fun |newton_1_4::main::1::IN@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_1_4::f::x@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_f$2@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_1_4::fp::x@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_fp$3@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_1_4::main::2::x@1!0&0#1| () (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$1@1!0&0#1|
   |newton_1_4::main::1::IN@1!0&0#1|))
(assert (= |newton_1_4::main::1::IN@1!0&0#1| |newton_1_4::f::x@1!0&0#1|))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   |newton_1_4::f::x@1!0&0#1|
...
(assert (= |newton_1_4::main::1::IN@1!0&0#1| |newton_1_4::fp::x@1!0&0#1|))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   |newton_1_4::fp::x@1!0&0#1|
                                   |newton_1_4::fp::x@1!0&0#1|)
                           |newton_1_4::fp::x@1!0&0#1|)
                   |newton_1_4::fp::x@1!0&0#1|)))
...
(assert (= (fp.sub roundNearestTiesToEven
   ...
   |newton_1_4::main::2::x@1!0&0#1|))
(assert (= (fp.lt |newton_1_4::main::2::x@1!0&0#1|
          (fp #b0 #x7b #b10011001100110011001101))
   |goto_symex::guard@0!0&0#1|))
(assert (let ((a!1 (ite (and (fp.gt |newton_1_4::main::1::IN@1!0&0#1|
                            (fp #b1 #x7e #b10011001100110011001101))
                     (fp.lt |newton_1_4::main::1::IN@1!0&0#1|
