...
file square_6_false-unreach-call.c: Parsing
Converting
...
(declare-fun |square_6_false-unreach-call::main::1::IN@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |square_6_false-unreach-call::main::2::result@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$1@1!0&0#1|
   |square_6_false-unreach-call::main::1::IN@1!0&0#1|))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (= (fp.sub roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     a!3
                     |square_6_false-unreach-call::main::1::IN@1!0&0#1|))
     |square_6_false-unreach-call::main::2::result@1!0&0#1|)))
(assert (= (or (fp.lt |square_6_false-unreach-call::main::2::result@1!0&0#1|
              (fp #b0 #x00 #b00000000000000000000000))
       (fp.geq |square_6_false-unreach-call::main::2::result@1!0&0#1|
               (fp #b0 #x7f #b01100110010111111101100)))
   |goto_symex::guard@0!0&0#1|))
(assert (let ((a!1 (ite (and (fp.geq |square_6_false-unreach-call::main::1::IN@1!0&0#1|
                             (fp #b0 #x00 #b00000000000000000000000))
                     (fp.lt |square_6_false-unreach-call::main::1::IN@1!0&0#1|
                            (fp #b0 #x7f #b00000000000000000000000)))
                #x00000001
                #x00000000)))
