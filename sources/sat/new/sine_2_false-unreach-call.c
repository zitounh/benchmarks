...
file sine_2_false-unreach-call.c: Parsing
Converting
...
(declare-fun |sine_2_false-unreach-call::main::1::IN@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |sine_2_false-unreach-call::main::2::result@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$1@1!0&0#1|
   |sine_2_false-unreach-call::main::1::IN@1!0&0#1|))
...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (= a!3 |sine_2_false-unreach-call::main::2::result@1!0&0#1|))))
(assert (= (fp.leq |sine_2_false-unreach-call::main::2::result@1!0&0#1|
           (fp #b0 #x7f #b00000000000000000000000))
   |goto_symex::guard@0!0&0#1|))
(assert (= (fp.geq |sine_2_false-unreach-call::main::2::result@1!0&0#1|
           (fp #b1 #x7f #b00000000000000000000000))
   |goto_symex::guard@0!0&0#2|))
(assert (let ((a!1 (ite (and (fp.gt |sine_2_false-unreach-call::main::1::IN@1!0&0#1|
                            (fp #b1 #x7f #b10010010000111111011011))
                     (fp.lt |sine_2_false-unreach-call::main::1::IN@1!0&0#1|
