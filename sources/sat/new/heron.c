...
(declare-fun |heron::main::1::a@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_nondet_float$2@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |nondet$symex::nondet1| () (_ FloatingPoint 8 24))
(declare-fun |heron::main::2::b@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_nondet_float$3@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |nondet$symex::nondet2| () (_ FloatingPoint 8 24))
(declare-fun |heron::main::3::c@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::heron::a@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::heron::b@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::heron::c@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::heron::1::s@2!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::heron::2::aire@2!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |heron::main::4::aire@1!0&0#2| () (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$3@1!0&0#1|
   |heron::main::3::c@1!0&0#1|))
(assert (= |heron::main::1::a@1!0&0#1| |heron::heron::a@1!0&0#1|))
(assert (= |heron::main::2::b@1!0&0#1| |heron::heron::b@1!0&0#1|))
(assert (= |heron::main::3::c@1!0&0#1| |heron::heron::c@1!0&0#1|))
(assert (= (fp.div roundNearestTiesToEven
           (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           |heron::heron::a@1!0&0#1|
                           |heron::heron::b@1!0&0#1|)
                   |heron::heron::c@1!0&0#1|)
           (fp #b0 #x80 #b00000000000000000000000))
   |heron::heron::1::s@2!0&0#1|))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           |heron::heron::1::s@2!0&0#1|
                           |heron::heron::c@1!0&0#1|))))
  (= a!1 |heron::heron::2::aire@2!0&0#1|)))
(assert (= |heron::heron::2::aire@2!0&0#1| |heron::main::4::aire@1!0&0#2|))
(assert (= (fp.geq |heron::main::4::aire@1!0&0#2|
           (fp #b0 #x6e #b01001111100010110101100))
   |goto_symex::guard@0!0&0#1|))
(assert (let ((a!1 (= (ite (fp.gt |heron::main::1::a@1!0&0#1|
                          (fp #b0 #x00 #b00000000000000000000000))
                   #x00000001
                   #x00000000)
              #x00000000))
      (a!2 (= (ite (fp.gt |heron::main::2::b@1!0&0#1|
                          (fp #b0 #x00 #b00000000000000000000000))
                   #x00000001
                   #x00000000)
              #x00000000))
      (a!3 (= (ite (fp.gt |heron::main::3::c@1!0&0#1|
                          (fp #b0 #x00 #b00000000000000000000000))
                   #x00000001
                   #x00000000)
              #x00000000))
      ...
      (a!6 (= (ite (fp.gt (fp.add roundNearestTiesToEven
                   ...
                   #x00000000)
              #x00000000))
      (a!7 (not (= (ite (fp.gt |heron::main::1::a@1!0&0#1|
                               |heron::main::2::b@1!0&0#1|)
                        #x00000001
                        #x00000000)
                   #x00000000)))
      (a!8 (not (= (ite (fp.gt |heron::main::2::b@1!0&0#1|
                               |heron::main::3::c@1!0&0#1|)
                        #x00000001
                        #x00000000)
                   #x00000000))))
