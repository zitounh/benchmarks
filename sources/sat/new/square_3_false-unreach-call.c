...
file square_3_false-unreach-call.c: Parsing
Converting
Generating GOTO Program
GOTO program creation time: 0.114s
...
(declare-fun |square_3_false-unreach-call::main::1::IN@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |square_3_false-unreach-call::main::2::result@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$1@1!0&0#1|
   |square_3_false-unreach-call::main::1::IN@1!0&0#1|))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (= (fp.sub roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     a!3
                     |square_3_false-unreach-call::main::1::IN@1!0&0#1|))
     |square_3_false-unreach-call::main::2::result@1!0&0#1|)))
(assert (= (fp.geq |square_3_false-unreach-call::main::2::result@1!0&0#1|
           (fp #b0 #x00 #b00000000000000000000000))
   |goto_symex::guard@0!0&0#1|))
(assert (= (fp.lt |square_3_false-unreach-call::main::2::result@1!0&0#1|
          (fp #b0 #x7f #b01100101111111111000001))
   |goto_symex::guard@0!0&0#2|))
(assert (let ((a!1 (ite (and (fp.geq |square_3_false-unreach-call::main::1::IN@1!0&0#1|
                             (fp #b0 #x00 #b00000000000000000000000))
                     (fp.lt |square_3_false-unreach-call::main::1::IN@1!0&0#1|
                            (fp #b0 #x7f #b00000000000000000000000)))
                #x00000001
                #x00000000)))
