...
int main()
{
   ...
   __VERIFIER_assume(a > -10000.0 && a < 10000.0);
    __VERIFIER_assume(b > -10000.0 && b < 10000.0);
    __VERIFIER_assume(c > -10000.0 && c < 10000.0);
    
    checkAdditiveAssociativityBound(a,b,c,0.1,100);    
}
