...
file newton_2_1_true-unreach-call.c: Parsing
Converting
...
(declare-fun |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::f::x@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_f$2@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::fp::x@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_fp$3@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::main::2::x@1!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::f::x@2!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_f$4@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::fp::x@2!0&0#1|
             ()
             (_ FloatingPoint 8 24))
(declare-fun |main::$tmp::return_value$_fp$5@1!0&0#1| () (_ FloatingPoint 8 24))
(declare-fun |newton_2_1_true-unreach-call::main::2::x@1!0&0#2|
             ()
             (_ FloatingPoint 8 24))
...
(assert (= |main::$tmp::return_value$_nondet_float$1@1!0&0#1|
   |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|))
(assert (= |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|
   |newton_2_1_true-unreach-call::f::x@1!0&0#1|))
...
(assert (= |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|
   |newton_2_1_true-unreach-call::fp::x@1!0&0#1|))
...
(assert (= (fp.sub roundNearestTiesToEven
   ...
   |newton_2_1_true-unreach-call::main::2::x@1!0&0#1|))
(assert (= |newton_2_1_true-unreach-call::main::2::x@1!0&0#1|
   |newton_2_1_true-unreach-call::f::x@2!0&0#1|))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   |newton_2_1_true-unreach-call::f::x@2!0&0#1|
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (= |newton_2_1_true-unreach-call::main::2::x@1!0&0#1|
   |newton_2_1_true-unreach-call::fp::x@2!0&0#1|))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   |newton_2_1_true-unreach-call::fp::x@2!0&0#1|
...
(assert (= (fp.sub roundNearestTiesToEven
   ...
   |newton_2_1_true-unreach-call::main::2::x@1!0&0#2|))
(assert (= (fp.lt |newton_2_1_true-unreach-call::main::2::x@1!0&0#2|
          (fp #b0 #x7b #b10011001100110011001101))
   |goto_symex::guard@0!0&0#1|))
(assert (let ((a!1 (ite (and (fp.gt |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|
                            (fp #b1 #x7c #b10011001100110011001101))
                     (fp.lt |newton_2_1_true-unreach-call::main::1::IN@1!0&0#1|
